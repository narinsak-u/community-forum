...
// Helper methods to calculate counts directly via the database.

// Upvotes counts all positive votes for a thread.
...
// Downvotes counts all negative votes for a thread.
...
// RepliesCount counts the top-level comments for a thread.
